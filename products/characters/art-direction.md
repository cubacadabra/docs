...
Future body families should have their own silhouette language rather than
reusing the person proportions with different attachments. A simple shared
face grammar may work across families, while anatomy, stance, and secondary
forms carry each family's character. This is future guidance, not a request to
start additional species before the current person study passes review.
...
[Current engine studies](../../media/evidence/character/README.md) compare:
...
See [runtime and verification](../../quality/verification/character-runtime.md).
