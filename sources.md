...
| `rust/docs/features_still_needed.md` | `SUPERSEDED` | Its proposed SDK 1.0 checklist is not a committed scope. Current gaps and selected acceptance requirements are in roadmap.md and verification/acceptance-criteria.md. |
