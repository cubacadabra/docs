...
behavior is specified in the [Morph catalog contract](../platform/morph-catalog.md).
...
[saved-appearance contract](../platform/morph-catalog.md#saved-appearance).
...
[current backend contract](../platform/morph-catalog.md). The standalone
...
described as shipped. See [host conformance](../compatibility/host-conformance.md)
