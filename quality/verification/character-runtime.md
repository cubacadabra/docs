...
Art decisions live in [Character art direction](../../products/characters/art-direction.md).
...
See [the native header](https://github.com/cubacadabra/rust/blob/main/include/cubacadabra_engine.h) for buffer ownership,
